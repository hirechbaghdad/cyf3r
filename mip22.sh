...
header(){
    ...
    printf "${BLUE}"	
	cat <<- EOF
        ${CYAN}Cyf3r is made for ethical usage only. 	${ORANGE}Version: 1.0  
        ${CYAN}The author is not responsible for any malicious use of the program.
		${CYAN} This tool was created by ${ORANGE}Hirech Baghdad ${CYAN}(https://github.com/hirechbaghdad) ${WHITE}
